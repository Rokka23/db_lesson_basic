...
department_id INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMAY KEY,
...
UPDATE people SET department_id = 2 WHERE name IN 
('高橋健', '前田大輔', '中村彩', '山本亮', '伊藤真由美');
...
-- Q10 名前と部署めいをその人が提出した日報の内容を同時に取得 --
...
SELECT people.name FROM people LEFT JOIN reports ON people.person_id = reports.person_id
